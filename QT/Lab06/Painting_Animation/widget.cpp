...
Widget::Widget(QWidget *parent) : QWidget(parent), scene_(new QGraphicsScene(this)), view_(new QGraphicsView(this)),
    field_(":data/field.jpg"), fox_(":data/fox.png"), length_(new QSlider(Qt::Horizontal, this)), height_(new QSlider(Qt::Vertical, this)){
